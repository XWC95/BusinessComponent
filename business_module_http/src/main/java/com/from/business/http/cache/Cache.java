 ...
 */
package com.from.business.http.cache;
...
/**
 * ================================================
 * 用于缓存框架中所必需的组件,开发者可通过 {@link HttpConfigModule.Builder#cacheFactory(Factory)} 为框架提供缓存策略
 * 开发者也可以用于自己日常中的使用
 *
 * @see HttpConfigModule#provideCacheFactory(Application)
 * @see LruCache
