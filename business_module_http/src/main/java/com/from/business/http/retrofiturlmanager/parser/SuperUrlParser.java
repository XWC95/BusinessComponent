 ...
 */
package com.from.business.http.retrofiturlmanager.parser;

import android.text.TextUtils;

import com.from.business.http.retrofiturlmanager.RetrofitUrlManager;
import com.from.business.http.retrofiturlmanager.cache.Cache;
import com.from.business.http.retrofiturlmanager.cache.LruCache;
...
import static com.from.business.http.retrofiturlmanager.RetrofitUrlManager.IDENTIFICATION_PATH_SIZE;
