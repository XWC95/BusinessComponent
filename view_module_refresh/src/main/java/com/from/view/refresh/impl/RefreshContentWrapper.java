package com.from.view.refresh.impl;
...
import com.from.view.refresh.listener.CoordinatorLayoutListener;
import com.from.view.refresh.util.DesignUtil;
...
import static com.from.view.refresh.util.ScrollBoundaryUtil.canScrollDown;
import static com.from.view.refresh.util.ScrollBoundaryUtil.canScrollUp;
import static com.from.view.refresh.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static com.from.view.refresh.util.SmartUtil.isContentView;
import static com.from.view.refresh.util.SmartUtil.measureViewHeight;
import static com.from.view.refresh.util.SmartUtil.scrollListBy;
